                        ...
                        <ul class="list-group list-group-flush">
                            @foreach ($members as $member)
                                <li class="list-group-item">
                                    <input class="form-check-input" type="checkbox" name="usernames[]" value="{{$member ->user->id}}">
                    ...
                    <div class="col-sm">
                        ...
                        <ul class=" list-group big-list list-group-flush ">
                            ...
                            <li class="list-group-item big-list">
                                <input class="form-check-input" type="radio" name="action" value="remove" checked
                    ...
                    <div class="col-sm" id="role_list">
                        ...
                        <ul class="list-group list-group-flush">
                            @foreach ($roles as $role)
                                <li class="list-group-item">
                                    <input class="form-check-input" type="checkbox" name="rolenames[]" value="{{$role ->id}}">
                                    {{$role ->name}}
                                </li>
                            @endforeach
                        </ul>
